...
export default function Message ({
  ...
  return (
      ...
      <div className='flex flex-col w-full gap-2'>
        ...
        >
          {inPinned && <div
              ...
              onClick={() => console.log("ToDo: Removing message from Pinned")}
            >
              <Image
                src='/icons/close.svg'
                alt='Close'
          ...
          {containsQuote && <QuotedMessage quotedMessage={{sender: "Sarah Johannsen", message: "Augue sit et aenean non tortor senectus sed. Sagittis eget in ut magna semper urna felis velit cursus. Enim nunc leo quis volutpat dis."}} setQuotedMessage={null} displayedWithMesageInput={false}/>}
          {messageText}
          </div>
          {!received && (
            <Image
          ...
          {received && !inThread && !inPinned && (
            <MessageActions
              ...
              pinMessageClick={() => {messageActionHandler(MessageActionsTypes.PIN, '')}}
              reactMessageClick={() => {messageActionHandler(MessageActionsTypes.REACT, '')}}
    ...
    {inPinned && <div className="flex flex-row place-self-center mt-2 border border-navy200 w-5/6"></div>}
        </div>
    )
}
